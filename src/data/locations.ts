...
export const brandLogos = [
  { name: 'Vincent', src: '/images/logo-vincent.webp' },
  { name: 'Veravent', src: '/images/logo-veravent.webp' },
  { name: 'Unika', src: '/images/logo-unika.webp' },
  { name: 'Sovet', src: '/images/logo-sovet.webp' },
  { name: 'Smeg', src: '/images/logo-smeg.webp' },
  { name: 'Siemens', src: '/images/logo-siemens.webp' },
  { name: 'Pladostelma', src: '/images/logo-pladostelma.webp' },
  { name: 'Ondarreta', src: '/images/logo-ondarreta.webp' },
  { name: 'Novy', src: '/images/logo-novy.webp' },
  { name: 'Frecan', src: '/images/logo-frecan.webp' },
  { name: 'Fiam', src: '/images/logo-fiam.webp' },
  { name: 'Cosentino', src: '/images/logo-cosentino.webp' },
  { name: 'Blanco', src: '/images/logo-blanco.webp' },
  { name: 'Andreu World', src: '/images/logo-andreu.webp' },
  { name: 'Codis', src: '/images/logo-codis.webp' },
  { name: 'Moradillo', src: '/images/logo-moradillo.webp' },
];
...
export const siteConfig = {
  ...
  facebook: 'https://www.facebook.com/people/MHK-Studiodesign/61573166356178/',
  instagram: 'https://www.instagram.com/mhkstudio.design?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw%3D%3D',
  whatsapp: 'https://wa.me/34608187921',
  pinterest: 'https://es.pinterest.com/mhkstudiodesign/?invite_code=a4babdb3c18045b7a92295ea466b704f&sender=1074953142216709837',
};
